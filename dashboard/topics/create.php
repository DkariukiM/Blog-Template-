...
<head>
    ...
    <title>Create Topics || <?php echo $_SESSION['username']; ?>.</title>
                    ...
                    <ul class="vertical-nav-menu">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="<?php echo BASE_URL . '/dashboard/topics/create.php'  ?>" class="mm-active">
                                        <i class="metismenu-icon">
                                        </i> Create topic
                                    </a>
                                </li>
                ...
                <div class="app-page-title">
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <button type="button" data-toggle="tooltip" title="Post Topics. To add a topic click on add." data-placement="bottom" class="btn-shadow mr-3 btn btn-dark">
                            ...
                            <div class="d-inline-block dropdown">
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="<?php echo BASE_URL . '/topics/create.php' ?>" class="nav-link">
                                                <i class="nav-link-icon lnr-book"></i>
                                                <span> Add Topic </span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="<?php echo BASE_URL . '/topics/index.php' ?>" class="nav-link">
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="mb-3 card">
                            <div class="card-header-tab card-header-tab-animation card-header">
                                ...
                                <ul class="nav">
                                    <li class="nav-item"><a href="<?php echo BASE_URL . '/dashboard/topics/index.php'  ?>" class=" nav-link">View</a></li>
                                    <li class="nav-item"><a href="<?php echo BASE_URL . '/dashboard/topics/create.php'  ?>" class="nav-link second-tab-toggle active">Add</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <form class="needs-validation" novalidate action="create.php" method="post">
                                        <?php include (ROOT_PATH . "/app/helpers/formErrors.php")?>
                                        <div class="form-row">
                                            <div class="col-md-12 mb-3">
                                                <label for="validationCustom01">Topic name</label>
                                                <input type="text" class="form-control" id="validationCustom01" name="name" placeholder="Topic name" value="<?php echo $name; ?>" required>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea class="form-control" id="validationCustom03" name="description"   required> <?php echo $description; ?></textarea>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-feedback">
                                        ...
                                        <button class="btn btn-primary" type="submit" name="add-topic" > Add </button>
                                    </form>
...
<script>
    ClassicEditor
        .create( document.querySelector( '#validationCustom03' ), {
