                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="mb-3 card">
                            <div class="card-header-tab card-header-tab-animation card-header">
                                ...
                                <ul class="nav">
                                    <?php if ($_SESSION['su_admin']): ?>
                                        <li class="nav-item"><a href="<?php echo BASE_URL . '/dashboard/posts/all.php'  ?>" class="active nav-link">All Posts</a></li>
                                        <li class="nav-item"><a href="<?php echo BASE_URL . '/dashboard/posts/index.php'  ?>" class=" nav-link">View</a></li>
                                    <?php else: ?>
                                        ...
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <?php foreach ($posts as $key => $post) :?>
                                                <tr>
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <div class="widget-content-left">
                                                                        <img width="40" height="40" class="rounded-circle" src="<?php echo BASE_URL . "/assets/img/" . $post['image']; ?>" alt="">
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <td class="text-left"><?php echo $post['username']; ?></td>
                                                    <td class="text-left"><?php echo date('F j, Y.', strtotime($post['created_at'])); ?></td>
                                                    <td class="text-center">
                                                        <a href="edit.php?id=<?php echo $post['id'];?>"><button type="button" rel="tooltip" title="Edit Post Details" class="btn btn-info btn-simple btn-xs">
                                                                <i class="fa fa-edit"></i>
                                                            </button></a>
                                                        <a href="index.php?del_id=<?php echo $post['id'];?>"><button type="button" rel="tooltip" title="Delete Post" class="btn btn-danger btn-simple btn-xs">
                                                                <i class="fa fa-times"></i>
                                                            </button></a>
                                                        <?php if ($post['published']): ?>
                                                            <a href="index.php?published=0&p_id=<?php echo $post['id'];?>"><button type="button" rel="tooltip" title="Post Published,Click to Unpublish " class="btn bg-grow-early btn-simple btn-xs">
                                                                    <i class="fa fa-check" style="color: white;"></i>
                                                                </button>
                                                            </a>
                                                        <?php else: ?>
                                                            <a href="index.php?published=1&p_id=<?php echo $post['id'];?>"><button type="button" rel="tooltip" title="Post Unpublished,Click to Publish" class="btn badge-warning btn-simple btn-xs">
