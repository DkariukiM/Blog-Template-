...
<head>
    ...
    <title>View Details || <?php echo $_SESSION['username']; ?>.</title>
                ...
                <div class="app-sidebar__inner">
                    <ul class="vertical-nav-menu">
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="<?php echo BASE_URL . '/dashboard/user/view.php'  ?>" class="mm-active">
                        ...
                        <div class="page-title-heading">
                            ...
                            <div> User Details
                                <div class="page-title-subheading">
                                    ...
                                    View user Details
                                    <?php else: ?>
                                    Add a photo so that other users know who you are.<br>
                                    <?php endif; ?>
                        ...
                        <div class="mb-3 card">
                            <div class="card-header-tab card-header-tab-animation card-header">
                                <div class="card-header-title">
                                    ...
                                    <?php echo $_SESSION['username'] ?>'s Details
                                </div>
                                <ul class="nav">
                                    <li class="nav-item"><a href="javascript:void(0);" class="active nav-link">View</a></li>
                                    <li class="nav-item"><a href="<?php echo BASE_URL . '/dashboard/user/edit.php'  ?>" class="nav-link second-tab-toggle">Edit</a></li>
                                </ul>
                            </div>
                            <div class="card-body">
                                <div class="tab-content">
                                    <form class="">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <input name="username" id="username"  value="<?php echo $image_preview['username'] ?>" type="text" disabled class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <input name="email" id="email" type="text" value="<?php echo $image_preview['email'] ?>" disabled class="form-control"></div>
                                            </div>

                                            <?php if ($_SESSION['admin']): ?>
                                            <div class="col-md-12">
                                                <div class="position-relative form-group">
                                                    <label for="status" class=""> Account Status </label>
                                                    <input name="admin" id="status" type="text" value="Admin" disabled class="form-control"></div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="position-relative form-group">
                                                    <label for="status" class=""> Account Status </label>
                                                    <input name="admin" id="status" type="text" value="User" disabled class="form-control"></div>
                                            </div>
                                            <?php endif; ?>
                                        ...
                                        <div class="position-relative form-group">
                                            ...
                                            <textarea name="description" id="description" disabled type="text"  class="form-control"> <?php echo html_entity_decode($image_preview['description']) ?> </textarea>
                                        </div>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="mb-3 card">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="text-center">
                                    <?php if ($image_preview['assigned_image']): ?>
                                        <img width="100" class="rounded-circle" src="<?php echo BASE_URL . "/assets/img/" . $image_preview['image']; ?>" alt="">
                                    <?php else: ?>
                                        <img width="100" class="rounded-circle" src="../../assets/img/face-0.jpg" alt="">
                                        <p class="text-center"> Add a photo so that other users know who you are.<br> Click on Edit to upload Image. </p>
                                    <?php endif; ?>
                                    <br>
                                    <h4 class="title"><?php echo $image_preview['username'] ?></h4>
                                    <h5><?php echo $image_preview['email'] ?></h5>
                                    <p class="text-center"> <?php echo html_entity_decode($image_preview['description']) ?></p>
