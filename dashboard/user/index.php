                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <?php if ($_SESSION['su_admin']): ?>
                                    ...
                                    <li>
                                        <a href="<?php echo BASE_URL . '/dashboard/user/index.php'  ?>" class="mm-active">
                                            <i class="metismenu-icon">
                                            </i>View Users.
                                        </a>
                                    </li>
                        ...
                        <div class="mb-3 card">
                            <div class="card-header-tab card-header-tab-animation card-header">
                                ...
                                <ul class="nav">
                                    ...
                                    <li class="nav-item"><a href="<?php echo BASE_URL . '/dashboard/user/create.php'  ?>" class="nav-link second-tab-toggle">Add User</a></li>
                                </ul>
                            </div>
                            <div class="card-body">
                                            ...
                                            <?php foreach ($users as $key => $user) :?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="editUser.php?id=<?php echo $user['id'];?>"><button type="button" rel="tooltip" title="Edit User Details" class="btn btn-info btn-simple btn-xs">
                                                                <i class="fa fa-edit"></i>
                                                            </button>
                                                        </a>
                                                        <a href="index.php?del_id=<?php echo $user['id'];?>"><button type="button" rel="tooltip" title="Delete User" class="btn btn-danger btn-simple btn-xs">
