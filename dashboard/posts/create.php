...
<head>
    ...
    <title>Create Post || <?php echo $_SESSION['username']; ?>.</title>
                        ...
                        <?php if ($_SESSION['admin']): ?>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="<?php echo BASE_URL . '/dashboard/posts/create.php'  ?>" class="mm-active">
                                            <i class="metismenu-icon">
                                            </i> Create Post
                                        </a>
                                    </li>
                            ...
                            <div class="d-inline-block dropdown">
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="<?php echo BASE_URL . '/posts/create.php' ?>" class="nav-link">
                        ...
                        <div class="mb-3 card">
                            <div class="card-header-tab card-header-tab-animation card-header">
                                ...
                                <ul class="nav">
                                    ...
                                    <li class="nav-item"><a href="<?php echo BASE_URL . '/dashboard/posts/create.php'  ?>" class="nav-link second-tab-toggle active">Add</a></li>
                                </ul>
                            </div>
                                    ...
                                    <form class="needs-validation" novalidate action="create.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom01" name="title" placeholder="Topic Title" value="<?php echo $title; ?>" required>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <div class="invalid-feedback">
                                                    Please provide Body of the post.
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <label for="validationCustom09">Profession</label>
                                                <select id="validationCustom09" name="topic_id" class="custom-select" required>
                                                    <option value=""></option>
                                            ...
                                            <div class="form-group">
                                                <div class="form-check">
                                                    ...
                                                    <?php else: ?>
                                                    <input class="form-check-input" type="checkbox" name="published" id="gridCheck" checked>
                                                    <label class="form-check-label" for="gridCheck">
                                                        Publish
                                                    </label>
                                                    <?php endif; ?>
                                        ...
                                        <button class="btn btn-primary" type="submit" name="create-post" > Create Post </button>
