...
<div class="modal-dialog">
    <div class="modal-content" style="background-color: deepskyblue;margin-top: 30%;" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="modal-heading">
            <h2 class="text-center heading-h2"> Sign Up </h2>
        </div>
        <hr />
            ...
            <form action="signup.php" method="post" role="form">
                ...
                <div class="form-group" data-aos="fade-right" data-aos-delay="400">
                    <div class="input-group">
                        ...
                        <input type="password" name="passwordConf" value="<?php echo $passwordConf; ?>" class="form-control" placeholder="Re-Enter Password" />
                ...
                <div class="form-group text-center form_link">
                    <button type="submit" name="register-btn" class="btn btn-success btn-lg" data-aos="fade-down" data-aos-delay="500"> Register </button>
                    <br>
                    <a href="<?php echo BASE_URL . '/index.php' ?>" class="btn btn-link" data-aos="fade-left" data-aos-delay="600"> < Back </a>
                    <a href="<?php echo BASE_URL . '/login.php' ?>" class="btn btn-link" data-aos="fade-right" data-aos-delay="600"> Aleady have an Account? </a>
                </div>
