...
$comments = comments($image_preview['id']);
...
<head>
    ...
    <title>View Comments || <?php echo $_SESSION['username']; ?>.</title>
                    ...
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            <div class="page-title-icon">
                                <i class="pe-7s-comment icon-gradient bg-happy-itmeo">
                                </i>
                            </div>
                            <div> Comments
                                <div class="page-title-subheading">
                                    Commenting History.<br>
                                    <?php include(ROOT_PATH . "/app/includes/messages.php");?>
                                </div>
                            </div>
                        </div>
                        <div class="page-title-actions">
                            <button type="button" data-toggle="tooltip" title=" All comments." data-placement="bottom" class="btn-shadow mr-3 btn btn-dark">
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a href="<?php echo BASE_URL . '/dashboard/dashboard.php' ?>" class="nav-link disabled">
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left flex2">
                                                                    <div class="widget-heading"><?php echo $comment['title']; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="text-left"><?php echo $comment['username']; ?></td>
                                                        <td class="text-left"><?php echo html_entity_decode($comment['comment']); ?></td>
