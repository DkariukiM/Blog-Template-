...
$description = $image_preview['description'];
                    ...
                    <ul class="vertical-nav-menu">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="<?php echo BASE_URL . '/dashboard/user/edit.php'  ?>" class="mm-active">
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="mb-3 card">
                            <div class="card-header-tab card-header-tab-animation card-header">
                                ...
                                <ul class="nav">
                                    <li class="nav-item"><a href="<?php echo BASE_URL . '/dashboard/user/view.php'  ?>" class=" nav-link">View</a></li>
