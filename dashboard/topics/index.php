...
<head>
    ...
    <title>View Topics || <?php echo $_SESSION['username']; ?>.</title>
                ...
                <div class="app-sidebar__inner">
                    <ul class="vertical-nav-menu">
                        ...
                        <li>
                            ...
                            <ul>
                                <li >
                                    <a href="<?php echo BASE_URL . '/dashboard/topics/index.php'  ?>" class="mm-active">
                                        <i class="metismenu-icon">
                                        </i> View Topics
                                    </a>
                                </li>
                        ...
                        <div class="mb-3 card">
                            <div class="card-header-tab card-header-tab-animation card-header">
                                ...
                                <ul class="nav">
                                    ...
                                    <li class="nav-item"><a href="<?php echo BASE_URL . '/dashboard/topics/create.php'  ?>" class="nav-link second-tab-toggle">Add</a></li>
                                </ul>
                            </div>
                            <div class="card-body">
                                        ...
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <?php foreach ($topics as $key => $topic) :?>
                                                <tr>
                                                    ...
                                                    <?php if ($_SESSION['su_admin']): ?>
                                                        <td class="text-center"><?php echo html_entity_decode($topic['description']); ?></td>
                                                    <?php endif; ?>
                                                    <td class="text-center">
                                                        <a href="edit.php?id=<?php echo $topic['id'];?>"><button type="button" rel="tooltip" title="Edit Topic Details" class="btn btn-info btn-simple btn-xs">
                                                                <i class="fa fa-edit"></i>
                                                            </button></a>
                                                        <?php if ($_SESSION['su_admin']): ?>
                                                            <a href="index.php?del_id=<?php echo $topic['id'];?>"><button type="button" rel="tooltip" title="Delete Topic" class="btn btn-danger btn-simple btn-xs">
