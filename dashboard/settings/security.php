...
$questions = selectAll('security_questions');
...
<head>
    ...
    <title>Create Security Question || <?php echo $_SESSION['username']; ?>.</title>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="mb-3 card">
                            <div class="card-header-tab card-header-tab-animation card-header">
                                ...
                                <ul class="nav">
                                    <li class="nav-item"><a href="<?php echo BASE_URL . '/dashboard/settings/index.php'  ?>" class=" nav-link">Back</a></li>
                                    <li class="nav-item"><a href="<?php echo BASE_URL . '/dashboard/settings/security.php'  ?>" class="nav-link second-tab-toggle active">Add</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <form class="needs-validation" novalidate action="security.php" method="post">
                                        <?php include (ROOT_PATH . "/app/helpers/formErrors.php")?>
                                        <div class="form-row">
                                            <div class="col-md-12 mb-3">
                                                <label for="validationCustom09"> Security Question </label>
                                                <select id="validationCustom09" name="question_id" class="custom-select" required>
                                                    <option value=""></option>

                                                    <?php foreach ($questions as $key => $question): ?>
                                                        <?php if (!empty($s_question && $s_question == $question['id'])): ?>
                                                            <option selected value=" <?php echo $question['id'] ?>"> <?php echo $question['question'] ?> </option>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-3">
                                                <label for="validationCustom03"> Answer </label>
                                                <textarea class="form-control" id="validationCustom03" name="answer"   required> <?php echo $answer; ?></textarea>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-feedback">
                                        ...
                                        <button class="btn btn-primary" type="submit" name="add-question" > Add </button>
                                    </form>
