                        ...
                        <div class="mb-3 card">
                            <div class="card-header-tab card-header-tab-animation card-header">
                                ...
                                <ul class="nav">
                                    ...
                                    <li class="nav-item"><a href="<?php echo BASE_URL . '/dashboard/topics/create.php'  ?>" class="nav-link second-tab-toggle active">Edit</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <form class="needs-validation" novalidate action="edit.php" method="post">
                                        ...
                                        <button class="btn btn-primary" type="submit" name="update-topic" > Update </button>
                                    </form>
