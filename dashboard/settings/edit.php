...
<head>
    ...
    <title>Edit Security Question || <?php echo $_SESSION['username']; ?>.</title>
                        ...
                        <div class="mb-3 card">
                            <div class="card-header-tab card-header-tab-animation card-header">
                                ...
                                <ul class="nav">
                                    ...
                                    <li class="nav-item"><a href="#" class="nav-link second-tab-toggle active">Add</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <form class="needs-validation" novalidate action="security.php" method="post">
                                        ...
                                        <button class="btn btn-primary" type="submit" name="update-question" > Add </button>
                                    </form>
